...
En sachant que la plupart des conséquences sont lié à 7 types de causes[^0] : 
...
[^0]: En 1962, l'ingénieur  Kaoru Ishikawa créer le diagramme de causes et effets pour identifier et définir l'ensemble des causes possibles. Il en défini 5 causes possibles dans la gestion de la qualité dans l'industrie. Qui deviendra le diagramme  de causes et effets d'Ishikawa. 


Nous considérons q'une définition claire d'un projet comporte 7 questions à répondre : 
