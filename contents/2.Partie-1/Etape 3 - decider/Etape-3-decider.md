...
Il est toujours surprenant de constater à quel point nous avons tendance à réduire le monde en solutions binaires, réduisant ainsi les possibilités dans des relations bivalentes ("ou") au lieu de relations complémentaires ("et"). Il en est de même dans la façon dont nous décidons des solutions envisagées. Au cours du chapitre précédent, nous avons vu la manière de générer des idées en évitant d'émettre des jugements. Or, il est commun qu'après cette phase de génération d'idées, les personnes tendent à juger les idées produites de manière binaire (c'est juste ou c'est faux). Comme la phase de divergence et d'émergence du précédent chapitre, la phase de convergence comporte quatre principes que vous pouvez garder à l'esprit durant la phase de décision.

Dans ce chapitre, vous découvrirez les quatre principes de la décision à respecter, ça vous aidera à éviter de vous perdre dans ce processus. Vous apprendrez quelle visualisation utiliser pour dessiner vos idées et les communiquer plus facilement aux personnes impliquées dans votre projet. Enfin, vous saurez comment aller à l'essentiel pour choisir une solution appropriée pour votre projet. La mise en pratique d'un exercice d'évaluation vous permettra de décider efficacement de la solution appropriée. 
...
**Rapidité de mise sur le marché :** A quelle rapidité pouvez-vous créer quelque chose à vendre ?
