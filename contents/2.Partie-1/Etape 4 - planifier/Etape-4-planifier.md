...
Apprendre à ne pas gasiller une seule minute de votre temps est le meilleur investissement que vous pouvez faire. Mais il est impossible de stocker ou mettre en réserve le temps. Le grand défi n'est pas uniquement de trouver des idées mais c'est de planifier la réalisation de ces idées, puisque la valeur est crée lors de l'implémentation des solutions. 
...
A travers le temps, différentes approches de planification comme Gantt[^gantt] ou PERTT[^pertt] ont été développées. Il est souvent difficile de planifier longtemps à l'avance – c'est pourquoi la *planification par scénario* est plus efficace pour des sujets qui comportent un grand nombre d'éléments nouveaux et inconnus.  
...
La planification par scénario est une apporche prospective (qui consiste à imaginer le futur possible). Commencez par planifier des scénarios qui permettent de visualiser le déroulement du projet. Posez-vous les questions suivantes : 
...
Ensuite, le début. Ce sont les premières étapes à partir de la situation actuelle. Décrivez les trois premières tâches et leur déroulement.
...
Peu importe s'il s'agit de créer une nouvelle entreprise, un nouveau produit ou une nouvelle façon de travailler, pour atteindre votre but vous devez créer une chaîne d'actions cohérente. Pour y parvenir, utilisez la méthode des *cinq comment*.
...
A la fin de la journée, prévoyez 30 minutes pour faire un résumé de la journée passée en répondant aux questions suivantes : *Qu'ai-je appris aujourd'hui  ? Qu'ai-je fait aujourd'hui qui m'a permis d'améliorer ma performance ?*
...
- Faire faire = Déléguer l’action : la majorité des tâches peuvent être faites tout aussi bien par une autre personne, déléguez-les. 
